<template>
  <div class="cookie-window" v-if="showWindow">
    <p class="cookie-window__message">
    ...
    <button class="cookie-window__button" @click="showCookieWindow">Согласен</button>
  </div>
</template>
...
.cookie-window {
  ...
  box-shadow: 0px 0px 24px 0px #0F12141A;
  z-index: 10;
  padding: 0px 63px;
